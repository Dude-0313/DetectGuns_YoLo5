...
For Guns dataset :
    $ python train.py --data guns_yolo5/guns_yolo5.yaml --weights yolov5s.pt --cfg guns_yolov5s.yaml --img 320 --batch-size 4

Usage - Multi-GPU DDP training:
    $ python -m torch.distributed.run --nproc_per_node 4 --master_port 1 train.py --data coco128.yaml --weights yolov5s.pt --img 640 --device 0,1,2,3

Problems and Solutions :
    P1 : Getting the Dataset ready
    S1: Wrote the script  convert_voc_to_yolo.py to convert PascalVOC dataset to YOLO format including image resize
    P2:  Win Error 1455 : THe paging file is too small for this operation
    S2: Changed basemodel to yolov5s (weights and config), reduced batch_size to 4 and virtual page max size to 64GB
